...
{
  SENSORS[i].gyro_x = FINGER_SENSOR_SIGN[0] * (SENSORS[i].AN[0] - SENSORS[i].AN_OFFSET[0]);
  SENSORS[i].gyro_y = FINGER_SENSOR_SIGN[1] * (SENSORS[i].AN[1] - SENSORS[i].AN_OFFSET[1]);
  SENSORS[i].gyro_z = FINGER_SENSOR_SIGN[2] * (SENSORS[i].AN[2] - SENSORS[i].AN_OFFSET[2]);
  }
}
...
{
  SENSORS[i].accel_x = FINGER_SENSOR_SIGN[3] * (SENSORS[i].AN[3] - SENSORS[i].AN_OFFSET[3]);
  SENSORS[i].accel_y = FINGER_SENSOR_SIGN[4] * (SENSORS[i].AN[4] - SENSORS[i].AN_OFFSET[4]);
  SENSORS[i].accel_z = FINGER_SENSOR_SIGN[5] * (SENSORS[i].AN[5] - SENSORS[i].AN_OFFSET[5]);
  }
