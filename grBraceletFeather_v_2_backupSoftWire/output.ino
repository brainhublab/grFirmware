...
void generatePackage()
{
  ...
  {
    output_data[j] = i;
    output_data[j + 1] = (int8_t)hb(IMUS[i].gyro_x);
    output_data[j + 2] = (int8_t)lb(IMUS[i].gyro_x);
    output_data[j + 3] = (int8_t)hb(IMUS[i].gyro_y);
    output_data[j + 4] = (int8_t)lb(IMUS[i].gyro_y);
    output_data[j + 5] = (int8_t)hb(IMUS[i].gyro_z);
    output_data[j + 6] = (int8_t)lb(IMUS[i].gyro_z);

    output_data[j + 7] = (int8_t)hb(IMUS[i].acc_x);
    output_data[j + 8] = (int8_t)lb(IMUS[i].acc_x);
    output_data[j + 9] = (int8_t)hb(IMUS[i].acc_y);
    output_data[j + 10] = (int8_t)lb(IMUS[i].acc_y);
    output_data[j + 11] = (int8_t)hb(IMUS[i].acc_z);
    output_data[j + 12] = (int8_t)lb(IMUS[i].acc_z);
